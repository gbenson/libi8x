...
I8X_EXPORT struct i8x_thing *
i8x_thing_ref (struct i8x_thing *thing)
{
  if (thing == NULL)
    return NULL;
...
I8X_EXPORT struct i8x_thing *
i8x_thing_unref (struct i8x_thing *thing)
{
  if (thing == NULL)
    return NULL;
...
I8X_EXPORT struct i8x_ctx *
i8x_thing_get_ctx (struct i8x_thing *thing)
{
  return thing->ctx;
}

I8X_EXPORT int
i8x_thing_new_from_string (struct i8x_ctx *ctx, const char *string,
...
I8X_EXPORT struct i8x_list_entry *
i8x_thing_get_some_list_entry (struct i8x_thing *thing)
{
  return NULL;
}
